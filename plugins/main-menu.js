...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let med = '⁖ฺ۟̇࣪·֗٬̤⃟✦';
    let img = 'https://files.catbox.moe/y5b41f.jpg';

    let menu = `
 ⚡ 𝒉𝒐𝒍𝒂 ${mention}, 𝒃𝒊𝒆𝒏𝒗𝒆𝒏𝒊𝒅𝒐 𝒂𝒍 𝒎𝒆𝒏𝒖 𝒅𝒆 ${bot}¡
...
`.trim();
    ...
    const buttons = [
      { buttonId: `${usedPrefix}status`, buttonText: { displayText: '📊 𝐄𝐒𝐓𝐀𝐃𝐎' }, type: 1 },
      { buttonId: `${usedPrefix}code`, buttonText: { displayText: '🛑 𝐒𝐄𝐑𝐁𝐎𝐓' }, type: 1 },
      { buttonId: `${usedPrefix}creador`, buttonText: { displayText: '🧃 𝐂𝐑𝐄𝐀𝐃𝐎𝐑' }, type: 1 }
    ];
